...
<footer class="text-center text-lg-start bg-light text-muted">
            ...
            <div class="row mt-3">
                ...
                <div class="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4">
                    ...
                    <h6 class="fw-bold mb-4">
                        <i class="fas fa-gem me-3"></i><span class="company">Laravel</span><span class="company_name">Lutrix</span>
                    </h6>
                    <p>
                        We provide the most up to date information on all things related to
                        movies
                    </p>
                </div>
                <!-- Grid column -->
    ...
    <div class="text-center p-4" style="background-color: rgba(0, 0, 0, 0.05);">
        ...
        <a class="text-reset fw-bold" href="https://mdbootstrap.com/">
            <a href="https://github.com/OBrien-reece" style="text-decoration: none;color: gray">Evans Indeche</a>
        </a>
    </div>
    <!-- Copyright -->
</footer>
